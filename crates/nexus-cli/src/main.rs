...
use nexus_core::algo::components::{component_stats, connected_components};
use nexus_core::algo::pagerank::{pagerank, PageRankConfig};
use nexus_core::algo::random_walk::{generate_walks, RandomWalkConfig};
use nexus_core::formats::{Csv, JsonLd, NTriples, Turtle};
...
fn cmd_components(input: &PathBuf, verbose: bool, strong: bool) -> Result<()> {
    use nexus_core::algo::components::strongly_connected_components;
