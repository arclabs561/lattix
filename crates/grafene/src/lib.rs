...
//!
//! `grafene` is a Rust library for graph learning and knowledge graphs:
//!
...
//! # Crate Structure
//!
//! - [`grafene_core`] - Core types: Triple, Entity, Relation, KnowledgeGraph
//! - [`grafene_nn`] - Graph neural network layers, Node2Vec, hyperbolic GNN
//! - [`grafene_kge`] - Knowledge Graph Embeddings (TransE, RotatE, ComplEx)
//! - [`grafene_temporal`] - Temporal graph primitives
//!
//! # Example
//!
//! ```rust
//! use grafene::{KnowledgeGraph, Triple};
//!
