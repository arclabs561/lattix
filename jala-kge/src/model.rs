...
//!
//! ```rust,ignore
//! use lattix_kge::{KGEModel, TransE, TrainingConfig};
//!
...
//! | `MuRP` | ndarray + hyp | `hyperbolic` | Planned |
...
// ============================================================================
// Conversions between Fact and lattix_core::Triple
// ============================================================================

impl From<Triple> for Fact<String> {
    /// Convert from `lattix_core::Triple` (discarding metadata).
...
impl From<Fact<String>> for Triple {
    /// Convert to `lattix_core::Triple` (with default confidence).
