...
use lattix_core::{EntityId, RelationType, Triple};

use crate::scoring::ScoringFunction;
use fynch::metrics as rank_metrics;
...
impl RankMetrics {
    ...
    pub fn from_ranks(ranks: &[usize]) -> Self {
        ...
        Self {
            mrr: rank_metrics::mrr(ranks),
            mr: rank_metrics::mean_rank(ranks),
            hits_at_1: rank_metrics::hits_at_k(ranks, 1),
            hits_at_3: rank_metrics::hits_at_k(ranks, 3),
            hits_at_10: rank_metrics::hits_at_k(ranks, 10),
...
///
/// ```rust,ignore
/// use lattix_kge::evaluation::{Evaluator, EvalTriple};
///
